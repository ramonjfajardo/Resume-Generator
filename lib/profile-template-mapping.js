...
export const profileTemplateMapping = {
    "RaMi": { resume: "Lafael_Miranda", template: "ResumeExecutiveNavy", prompt: "default" },
    "LuMo": { resume: "Lucas_Moura", template: "ResumeCreativeBurgundy", prompt: "default" },
    "LuPe": { resume: "Lucas_Peralta", template: "ResumeConsultantSteel", prompt: "default" }
};
...
export const getTemplateForProfile = (slug) => getProfileProperty(slug, 'template', 'Resume');
export const getPromptForProfile = (slug) => getProfileProperty(slug, 'prompt', 'default');
